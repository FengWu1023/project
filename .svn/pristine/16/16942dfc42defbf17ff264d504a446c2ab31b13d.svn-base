class Car{
    ...
    display(){
        ...
        if(this.goods.length==0){
            str =` <tr><td colspan="7"><a href="index.html"><img src="imgs/emptycart.png" class="emptyc"/></a></td></tr>`;
        }
        var count =0;
        ...
        this.tbody.addEventListener("click",function(e){
            if(e.target.tagName==="SPAN"){
                ...
                if (that.tr.length==0){
                    ...
                    <tr>
                        <td colspan="7"><a href="index.html"><img src="imgs/emptycart.png" class="emptyc"/></a></td>
                    </tr>
